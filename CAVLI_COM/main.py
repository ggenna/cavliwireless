...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setStyleSheet("background-color: #ddeeee;")
       ...
       # self.any_panel_3.any_btn.clicked.connect(self.send_any)
        ...
        image_path = os.path.join(os.path.expanduser("~"), "myprojectPython/CAVLI_COM/images", "Cavli_Wireless.png")
        pixmap = QPixmap(image_path)  # Sostituisci con il percorso del tuo file immagine

        # Imposta l'immagine come icona della finestra e spostala nella barra del titolo
